...
from oh_my_dynamic.runtime.task import Task, TaskStatus
from oh_my_dynamic.core.agents import AgentRole, PLANNER, BUILDER, REVIEWER, ROLE_MAP
from oh_my_dynamic.core.llm_client import call_llm
from oh_my_dynamic.core.message_bus import MessageBus, Message
...
class TeamEngine:
        ...
        while True:
            ...
            try:
                ...
                if not self.config.auto_approve and role.name == "builder":
                    ...
                    from oh_my_dynamic.runtime.orchestrator import _parse_review_verdict
    ...
    def run(self, goal: str = "", context: str = "") -> dict:
        ...
        if goal:
            ...
            # 解析计划并创建任务
            from oh_my_dynamic.runtime.orchestrator import parse_plan
