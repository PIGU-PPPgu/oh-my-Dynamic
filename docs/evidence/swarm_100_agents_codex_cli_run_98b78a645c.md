...
```json
{
  ...
  "trace_manifest_path": "$REPO_ROOT/.orchestry/evidence_swarm/codex_cli_run_98b78a645c/manifest.json",
  "trace_path": "$REPO_ROOT/.orchestry/evidence_swarm/codex_cli_run_98b78a645c/trace.json",
  "known_limitations": [
