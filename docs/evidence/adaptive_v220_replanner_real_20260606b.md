...
```json
{
  ...
  "rounds": [
    {
      ...
      "failed": 0,
      "duration_s": 428.1,
      "trace_path": "$REPO_ROOT/.orchestry/adaptive_workflow/adaptive_v220_replanner_real_20260606b/round_0/adaptive_v220_replanner_real_20260606b/trace.json"
    },
    {
      "round_index": 1,
      "source": "replanner",
      ...
      "failed": 0,
      "duration_s": 181.82,
      "trace_path": "$REPO_ROOT/.orchestry/adaptive_workflow/adaptive_v220_replanner_real_20260606b/round_1/adaptive_v220_replanner_real_20260606b/trace.json"
    }
  ],
  "replan_triggers": [
    {
  ...
  "dynamic_trace_path": "$REPO_ROOT/.orchestry/adaptive_workflow/adaptive_v220_replanner_real_20260606b/dynamic_trace.json",
  "known_limitations": [
