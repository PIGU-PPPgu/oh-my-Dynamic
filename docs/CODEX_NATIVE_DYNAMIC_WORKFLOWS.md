...
artifact publication, handoffs, review requests, and completion events. This is
not a replacement for Codex App-native scheduling, but it gives external tools a
real transport boundary to drive and inspect broker-backed workflows.
